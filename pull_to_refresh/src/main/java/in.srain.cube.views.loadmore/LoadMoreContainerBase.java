...
public abstract class LoadMoreContainerBase extends LinearLayout implements LoadMoreContainer {
    ...
    private ListViewScrollListener listScroolListener;
    ...
    private void init() {
        ...
        mAbsListView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if (listScroolListener != null) {
                    listScroolListener.onScroll(view, firstVisibleItem, visibleItemCount, totalItemCount);
                }
    ...
    public void setListScroolListener(ListViewScrollListener listScroolListener) {

        this.listScroolListener = listScroolListener;
    }
}