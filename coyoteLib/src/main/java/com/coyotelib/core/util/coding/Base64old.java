...
final class Base64old {
	...
	/**
	 * Decodes a 7 bit Base64old character into its binary value.
	 */
	...
	/**
	 * Converts a byte array into a Base64old encoded string.
	 * 
	 * @param data
	 *            bytes to encode
	 * @param offset
	...
	/**
	 * Encodes 1, 2, or 3 bytes of data as 4 Base64old chars.
	 * 
	 * @param in
	...
	/**
	 * Converts an embedded Base64old encoded string to a byte array.
	 * 
	 * @param encoded
	 *            a String with Base64old data embedded in it
	 * @param offset
	...
	private static byte[] decode(String encoded, int offset, int length)
		...
		if (length % 4 != 0) {
			throw new IOException("Base64old string length is not multiple of 4");
		}
	...
	/**
	 * Decode 4 Base64old chars as 1, 2, or 3 bytes of data.
	 * 
	 * @param in1
	...
	private static void decodeQuantum(char in1, char in2, char in3, char in4,
		...
		if (a < 0 || b < 0 || c < 0 || d < 0) {
			throw new IOException("Invalid character in Base64old string");
		}
	...
	/**
	 * Converts a Base64old encoded string to a byte array.
	 * 
	 * @param encoded
	 *            Base64old encoded data
	 * @return decode binary data; 3 bytes for every 4 chars - minus padding
	 * @exception IOException
	 *                is thrown, if an I/O error occurs reading the data
	 */
